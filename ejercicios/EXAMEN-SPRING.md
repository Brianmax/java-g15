...
| Método HTTP | Endpoint | Descripción | Status esperado |
|-------------|----------|-------------|-----------------|
| POST | `/save` | Registrar un nuevo propietario | 201 Created |
| GET | `/find/{id}` | Buscar propietario por ID | 200 OK |
| GET | `/find/apellido/{apellido}` | Buscar propietarios por apellido | 200 OK |

### `MascotaController` — base path: `/api/v1/mascota`

| Método HTTP | Endpoint | Descripción | Status esperado |
|-------------|----------|-------------|-----------------|
| POST | `/save` | Registrar una nueva mascota | 201 Created |
| GET | `/find/especie/{especie}` | Buscar mascotas por especie | 200 OK |
